...
namespace Commons.DeepFrees.DatabaseConfiguration
{
    public class MongoDBConn
    {
        ...
        public static readonly string[] DeepFreesDataCollections = new string[] { "UserAccount", "Employee", "DeepFreesPay", "Employee", "WorkTasks" , "Technicians", "Route", "Location", "DistanceModel", "UserSettings" };
